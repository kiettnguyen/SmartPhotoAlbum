...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://wny1ozqeij.execute-api.us-east-1.amazonaws.com/test';
    ...
    apigClient.uploadBucketKeyPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['key', 'x-api-key', 'bucket', 'x-amz-meta-customLabels'], ['body']);
        
        var uploadBucketKeyPutRequest = {
            verb: 'put'.toUpperCase(),
            path: pathComponent + uritemplate('/upload/{bucket}/{key}').expand(apiGateway.core.utils.parseParametersToObject(params, ['key', 'bucket', ])),
            headers: apiGateway.core.utils.parseParametersToObject(params, ['x-api-key', 'x-amz-meta-customLabels']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
